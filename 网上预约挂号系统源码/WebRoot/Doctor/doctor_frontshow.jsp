...
<div class="container">
	...
	<div class="row bottom15">
		...
		<div class="col-md-6 col-xs-6">
			<button onclick="javascript:location.href='<%=basePath %>OrderInfo/orderInfo_frontUserAdd.jsp?doctorNumber=<%=doctor.getDoctorNumber() %>'" class="btn btn-primary">预约此医生</button>
